    ...
    return [
      {
        ...
        description: 'Intelligent reading assistant that provides real-time feedback and explanations.',
        status: 'in_progress',
        priority: 'high',
        category: 'feature',
        progress: 75,
      ...
      {
        id: 2,
        title: 'Speaking Practice Mode',
        description: 'IELTS speaking test simulator with AI-powered pronunciation feedback.',
        status: 'planned',
        priority: 'high',
        category: 'feature',
        progress: 20,
      ...
      },
      {
        id: 5,
        title: 'Bug Fixes',
        description: 'Fix various UI issues and improve error handling.',
        status: 'completed',
        priority: 'high',
        category: 'bug_fix',
        progress: 100,
