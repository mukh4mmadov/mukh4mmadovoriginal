...
export class SyncService {
   ...
   */
  async syncReadingHistory(userId) {
    try {
   ...
   */
  async syncAIConversations(userId) {
    try {
   ...
   * Sync daily missions
   */
  async syncDailyMissions(userId) {
    try {
