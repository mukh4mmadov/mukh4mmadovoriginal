export const newPassages = [
  {
    ...
    questionGroups: [
      {
        instructions:
          "Questions 1–7. Reading Passage 1 has six sections, A–F. Which section contains the following information? Write the correct letter, A–F, in boxes 1–7 on your answer sheet. NB You may use any letter more than once.",
        questions: [
          {
            id: "q1",
            number: 1,
            ...
            answer: "B",
            explanation:
              "Paragraph B discusses how little we know about bamboo and mentions a report revealing our ignorance of global bamboo resources.",
          },
          {
            id: "q2",
            number: 2,
            ...
            answer: "E",
            explanation:
              "Paragraph E compares bamboo with other plants, noting that bamboo can take care of itself while other plants may not survive in their habitat.",
          },
          {
            id: "q3",
            number: 3,
            ...
            answer: "D",
            explanation:
              "Paragraph D focuses on bamboo's economic value, trade, and commercial uses.",
          },
          {
            id: "q4",
            number: 4,
            ...
            answer: "A",
            explanation:
              "Paragraph A mentions how populations have exploded and bamboo forests have been cleared for commercial plantations.",
          },
          {
            id: "q5",
            number: 5,
            ...
            answer: "B",
            explanation:
              "Paragraph B states that only 38 'priority species' have been the subject of real scientific research.",
          },
          {
            id: "q6",
            number: 6,
            ...
            answer: "D",
            explanation:
              "Paragraph D lists various uses of bamboo including flooring, laminates, construction, and paper.",
          },
          {
            id: "q7",
            number: 7,
            ...
            answer: "C",
            explanation:
              "Paragraph C explains how bamboo's pattern of mass flowering and death creates patches that help preserve plant diversity.",
          },
        ],
      },
      {
        instructions:
          "Questions 8–11. Look at the following statements (Questions 8–11) and the list of people below. Match each statement with the correct person, A–D. NB You may use any letter more than once.",
        questions: [
          {
            id: "q8",
            number: 8,
            ...
            answer: "B",
            explanation:
              "Valerie Kapos is quoted saying 'In a lot of places, the people who live with bamboo don't perceive it as being under threat in any way.'",
          },
          {
            id: "q9",
            number: 9,
            ...
            answer: "A",
            explanation:
              "Ian Redmond states that without bamboo, the chances of survival for mountain gorillas would be reduced significantly.",
          },
          {
            id: "q10",
            number: 10,
            ...
            answer: "B",
            explanation:
              "Dr Valerie Kapos says 'People have only started looking at this during the past 10-15 years, and only now are they understanding how to go about it systematically.'",
          },
          {
            id: "q11",
            number: 11,
            ...
            answer: "D",
            explanation:
              "Ray Townsend states 'What is under threat is its habitat. When forest goes, it's converted into something else.'",
          },
        ],
      },
      {
        instructions:
          "Questions 12 and 13. Answer the questions below. Choose NO MORE THAN TWO WORDS from the passage for each answer.",
        questions: [
          {
            id: "q12",
            number: 12,
            ...
            answer: ["soil erosion"],
            explanation:
              "Paragraph C states 'Its rhizome systems, which lie in the top layers of the soil, are crucial in preventing soil erosion.'",
          },
          {
            id: "q13",
            number: 13,
            ...
            answer: ["paper"],
            explanation:
              "Paragraph D mentions 'one of the fastest growing bamboo products is paper'.",
          },
        ],
      },
    ],
...

  {
    ...
    questionGroups: [
      {
        instructions:
          "Questions 14–20. Do the following statements agree with the information given in Reading Passage 2? In boxes 14–20 on your answer sheet, write TRUE if the statement agrees with the information, FALSE if the statement contradicts the information, NOT GIVEN if there is no information on this.",
        questions: [
          {
            id: "q14",
            number: 14,
            ...
            answer: "FALSE",
            explanation:
              "The passage states that wind power costs around 7 cents per kilowatt-hour while coal costs 4 cents, making alternative energy more expensive.",
          },
          {
            id: "q15",
            number: 15,
            ...
            answer: "TRUE",
            explanation:
              "The passage states 'the system needs some additional features if it is to be environmentally friendly' and mentions radon gas needs to be removed.",
          },
          {
            id: "q16",
            number: 16,
            ...
            answer: "NOT GIVEN",
            explanation:
              "The passage mentions Dr. Chopra notes that steam will bring radon gas, but does not state she has studied its environmental effects.",
          },
          {
            id: "q17",
            number: 17,
            ...
            answer: "TRUE",
            explanation:
              "The passage states 'the Australian source is so large it could supply the entire country's needs for thousands of years'.",
          },
          {
            id: "q18",
            number: 18,
            ...
            answer: "FALSE",
            explanation:
              "The passage states the new site 'will mean increased revenue from tourism', suggesting tourists will be attracted, not kept away.",
          },
          {
            id: "q19",
            number: 19,
            ...
            answer: "TRUE",
            explanation:
              "The passage states 'Wavetech was created when Dr. Tim Devine offered the idea to the world leader in wave generator manufacturers, who rather surprisingly rejected it.'",
          },
          {
            id: "q20",
            number: 20,
            ...
            answer: "FALSE",
            explanation:
              "Richard Hunter of the AEA states 'We should really be at the forefront, but the reality is we are a long way behind.'",
          },
        ],
      },
      {
        instructions:
          "Questions 21–26. Look at the following statements (Questions 21–26) and the list of companies below. Match each statement with the correct company, A–D. Write the correct letter, A–D, in boxes 21–26 on your answer sheet. NB You may use any letter more than once.",
        questions: [
          {
            id: "q21",
            number: 21,
            ...
            answer: "B",
            explanation:
              "Geoenergy's system sends radon gas through a heat exchanger and back underground to prevent it from escaping.",
          },
          {
            id: "q22",
            number: 22,
            ...
            answer: "D",
            explanation:
              "Wavetech's invention uses waves to push water into a chamber where the flowing water column pushes air through a turbine.",
          },
          {
            id: "q23",
            number: 23,
            ...
            answer: "A",
            explanation:
              "Australian Hydro is 'mostly just replicating European designs' for wind power.",
          },
          {
            id: "q24",
            number: 24,
            ...
            answer: "C",
            explanation:
              "Enviropower's new site will provide revenue from tourism, telecommunications, and agribusiness in addition to energy.",
          },
          {
            id: "q25",
            number: 25,
            ...
            answer: "B",
            explanation:
              "Geoenergy 'is proposing to pump water 3.5 kilometres into the earth'.",
          },
          {
            id: "q26",
            number: 26,
            ...
            answer: "C",
            explanation:
              "Enviropower 'recognized that the quality of sunlight in the Mildura district will require a substantially larger collecting area than was previously thought.'",
          },
        ],
      },
    ],
        ...
        questions: [
          {
            ...
            answer: "F",
            explanation:
              "Paragraph F explains how mirror neurons allow spectators to share in the feelings of victory through connection to the amygdalae.",
          },
          {
            id: "q28",
            number: 28,
            ...
            answer: "B",
            explanation:
              "Paragraph B explains that novices swing with their consciousness using an area of brain next to the premotor cortex, making skills difficult.",
          },
          {
            id: "q29",
            number: 29,
            ...
            answer: "E",
            explanation:
              "Paragraph E states 'The best athletes are those with a premotor cortex capable of imagining the movements of victory, together with the physical properties to make those movements real.'",
          },
          {
            id: "q30",
            number: 30,
            ...
            answer: "C",
            explanation:
              "Paragraph C states 'Humans have an even more elaborate mirror neuron system' compared to monkeys.",
          },
          {
            id: "q31",
            number: 31,
            ...
            answer: "D",
            explanation:
              "Paragraph D mentions that 'This phenomenon of neural mirror was first discovered in 1954, when two French physiologists, Gastaut and Berf, found that the brains of humans vibrate with two distinct wavelengths'.",
          },
          {
            id: "q32",
            number: 32,
            ...
            answer: "E",
            explanation:
              "Paragraph E states 'watching a great golfer makes us better golfers, and watching a great sprinter actually makes us run faster.'",
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            answer: "C",
            explanation:
              "Paragraph B states 'These networks of cells are the bodily \"sentences\" we use every day' and refers to them as 'grammars of movement', meaning patterns of connected cells.",
          },
          {
            id: "q34",
            number: 34,
            ...
            answer: "A",
            explanation:
              "Paragraph B states 'For him, the motor action has become memorized, and the movements are embedded in the neurons of his premotor cortex. He hits the ball with the tranquility of his perfected autopilot.'",
          },
          {
            id: "q35",
            number: 35,
            ...
            answer: "C",
            explanation:
              "Paragraph F states 'Rather, we watch sport for the feeling, the human drama' and explains how mirror neurons allow spectators to share in the feelings of victory.",
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            answer: "YES",
            explanation:
              "Paragraph B states that novices 'swing with their consciousness', meaning they are too aware of what they are doing.",
          },
          {
            id: "q37",
            number: 37,
            ...
            answer: "NO",
            explanation:
              "Paragraph C states 'Humans have an even more elaborate mirror neuron system', contradicting the statement.",
          },
          {
            id: "q38",
            number: 38,
            ...
            answer: "NO",
            explanation:
              "Paragraph C states 'If we are staring at a photograph, a fixed image of a runner mid-stride, our mirror neurons are totally silent.'",
          },
          {
            id: "q39",
            number: 39,
            ...
            answer: "NOT GIVEN",
            explanation:
              "The passage mentions Gastaut and Bert were researchers but does not state whether they were also sports players.",
          },
          {
            id: "q40",
            number: 40,
            ...
            answer: "YES",
            explanation:
              "Paragraph D states 'The mu system is involved in neural mirroring. It is active when your bodies are still, and disappears whenever we do something active', meaning it is at rest when we are engaged in an activity.",
          },
        ],
      },
    ],
...

  {
    ...
    questionGroups: [
      {
        instructions:
          "Questions 1–6. Do the following statements agree with the information given in Reading Passage 1? In boxes 1–6 on your answer sheet, write TRUE if the statement agrees with the information, FALSE if the statement contradicts the information, NOT GIVEN if there is no information on this.",
        questions: [
          {
            id: "q1",
            number: 1,
            ...
            answer: "FALSE",
            explanation:
              "The passage states that Caral 'was a thriving metropolis when Egypt's great pyramids were still being built', meaning Caral existed while pyramids were being built, not that they were built at the same time.",
          },
          {
            id: "q2",
            number: 2,
            ...
            answer: "TRUE",
            explanation:
              "The passage states that not finding pottery 'meant Caral could be what archaeologists term pre-ceramic', which was a significant clue about its age.",
          },
          {
            id: "q3",
            number: 3,
            ...
            answer: "FALSE",
            explanation:
              "The passage states the workers 'must have filled these bags with stones from a nearby quarry', not from far away.",
          },
          {
            id: "q4",
            number: 4,
            ...
            answer: "TRUE",
            explanation:
              "The passage states 'Thousands of manual labourers would have been needed to build such a project, not counting the many architects, craftsmen, and managers.'",
          },
          {
            id: "q5",
            number: 5,
            ...
            answer: "NOT GIVEN",
            explanation:
              "The passage states they found musical instruments and that 'Clearly music played an important role in Caral's society', but does not state whether the residents were highly skilled musicians.",
          },
          {
            id: "q6",
            number: 6,
            ...
            answer: "FALSE",
            explanation:
              "The passage states 'These indicate a hierarchy of living arrangements: large, well-kept rooms atop pyramids for the elite, ground-level quarters for the middle class, and shabbier outlying dwellings for workers.'",
          },
        ],
      },
      {
        instructions:
          "Questions 7–13. Complete the notes below. Choose ONE WORD ONLY from the passage for each answer. Write your answers in boxes 7–13 on your answer sheet.",
        questions: [
          {
            id: "q7",
            number: 7,
            ...
            answer: ["seeds"],
            explanation:
              "The passage mentions 'seeds of the cocoa bush' as items discovered at Caral.",
          },
          {
            id: "q8",
            number: 8,
            ...
            answer: ["shells"],
            explanation:
              "The passage mentions 'necklaces of shells' as items discovered at Caral.",
          },
          {
            id: "q9",
            number: 9,
            ...
            answer: ["fish"],
            explanation:
              "The passage states they found 'the bones of small edible fish' in the excavations.",
          },
          {
            id: "q10",
            number: 10,
            ...
            answer: ["canals"],
            explanation:
              "The passage states 'Caral's early farmers diverted the area's rivers into canals, which still cross the Supe Valley today'.",
          },
          {
            id: "q11",
            number: 11,
          ...
          },
          {
            ...
            answer: ["cotton"],
            explanation:
              "The passage states 'The farmers of Caral grew the cotton that the fishermen needed to make their nets'.",
          },
          {
            id: "q13",
            number: 13,
            ...
            answer: ["flotation"],
            explanation:
              "The passage states 'the fishermen probably used dried squash grown by the Caral people as flotation devices for their nets'.",
          },
        ],
      },
    ],
...

  {
    ...
    questionGroups: [
      {
        instructions:
          "Questions 14–19. Reading Passage 2 has six paragraphs, A–F. Choose the correct heading for each paragraph from the list of headings below. Write the correct number, i–ix, in boxes 14–19 on your answer sheet.",
        questions: [
          {
            id: "q14",
            number: 14,
            ...
            answer: "vi",
            explanation:
              "Paragraph A discusses the problems and costs of using humans in space exploration.",
          },
          {
            id: "q15",
            number: 15,
            ...
            answer: "iii",
            explanation:
              "Paragraph B discusses limitations of robots, including their inability to react to unprepared situations.",
          },
          {
            id: "q16",
            number: 16,
            ...
            answer: "i",
            explanation:
              "Paragraph C discusses how predictions about AI and robots are being revised, representing a re-evaluation.",
          },
          {
            id: "q17",
            number: 17,
            ...
            answer: "v",
            explanation:
              "Paragraph D discusses how humans and machines are now working together in space, a reconsideration of responsibilities.",
          },
          {
            id: "q18",
            number: 18,
            ...
            answer: "ix",
            explanation:
              "Paragraph E gives examples of how humans and robots could cooperate in space exploration.",
          },
          {
            id: "q19",
            number: 19,
            ...
            answer: "viii",
            explanation:
              "Paragraph F discusses space settlement and how living in space changes human self-awareness.",
          },
        ],
      },
      {
        instructions:
          "Questions 20 and 21. Choose TWO letters, A–E. Write the correct letters in boxes 20 and 21 on your answer sheet. According to the writer, which TWO predictions about artificial intelligence have not yet been fulfilled?",
        questions: [
          {
            id: "q20",
            number: 20,
            ...
            answer: "A",
            explanation:
              "The passage states that predictions about fully automated factories and complete substitution of workers by robots are being revised.",
          },
          {
            id: "q21",
            number: 21,
            ...
            answer: "D",
            explanation:
              "The passage states that building machines which display logical abilities has proven very difficult.",
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            explanation:
              "Paragraph E states robots would 'establish the infrastructure needed to prepare future landing sites'.",
          },
          {
            id: "q23",
            number: 23,
            ...
            answer: ["spaceships"],
            explanation:
              "Paragraph E suggests 'robots could be controlled by human beings located in spaceships which remain in orbit around the planet'.",
          },
          {
            id: "q24",
            number: 24,
            ...
            explanation:
              "The context suggests communication would be faster with humans in orbit rather than on Earth.",
          },
          {
            id: "q25",
            number: 25,
            ...
            answer: ["laboratories"],
            explanation:
              "Paragraph F mentions space as 'a place to build automatic laboratories'.",
          },
          {
            id: "q26",
            number: 26,
            ...
            answer: ["colonisation"],
            explanation:
              "Paragraph F states 'the aim for humankind in the future will be not just the exploration of space, but its colonisation'.",
          },
        ],
      },
    ],
...

  {
    ...
    questionGroups: [
      {
        instructions:
          "Questions 27–29. Complete each sentence with the correct ending, A–E, below. Write the correct letter, A–E, in boxes 27–29 on your answer sheet.",
        questions: [
          {
            id: "q27",
            number: 27,
            ...
            options: [
              {
                key: "A",
                text: "requires more detailed study by psychologists.",
              },
              {
                key: "B",
                text: "means people have no time to challenge the significance of the new technology.",
              },
              { key: "C", text: "may reduce inventiveness and innovation." },
              {
                key: "D",
                text: "suggests computers will take over the workplace.",
              },
              {
                key: "E",
                text: "results from increased electronic supervision.",
              },
            ],
            answer: "B",
            explanation:
              "The first paragraph states 'Most of us are too busy struggling to keep pace with ongoing innovations to question the implications of our new electronic authority figures.'",
          },
          {
            id: "q28",
            number: 28,
            ...
            answer: "C",
            explanation:
              "Brod warns that over-reliance on electronic tools could have serious repercussions on our ability to think creatively and develop new ideas.",
          },
          {
            id: "q29",
            number: 29,
            ...
            answer: "E",
            explanation:
              "The passage describes how service people curtly terminate conversation because their performance is being electronically monitored.",
          },
        ],
      },
      {
        instructions:
          "Questions 30–35. Look at the following statements and the list of people below. Match each statement with the correct person or people, A, B, C or D. Write the correct letter, A, B, C or D, in boxes 30–35 on your answer sheet. NB You may use any letter more than once.",
        questions: [
          {
            id: "q30",
            number: 30,
            ...
            answer: "B",
            explanation:
              "Daniel Dennett points out that modern technology eliminates the possibility of unavoidable ignorance, making the obligation to make accurate predictions more onerous.",
          },
          {
            id: "q31",
            number: 31,
            ...
            answer: "A",
            explanation:
              "Craig Brod says people 'need complete isolation to recover from the effects of the technology' when they leave the office.",
          },
          {
            id: "q32",
            number: 32,
            ...
            answer: "A",
            explanation:
              "Brod points out 'we need to avoid the temptation to replace informal gatherings for bouncing ideas off colleagues with electronic networking'.",
          },
          {
            id: "q33",
            number: 33,
            ...
            answer: "D",
            explanation:
              "Philip Nicholson likens the psychic numbing of electronic information overload to symptoms of post-traumatic stress syndrome.",
          },
          {
            id: "q34",
            number: 34,
            ...
            answer: "C",
            explanation:
              "Boyett and Conn describe a future in which millions of people charged with analysing information will be replaced by less skilled workers using intelligent software.",
          },
          {
            id: "q35",
            number: 35,
            ...
            answer: "D",
            explanation:
              "Nicholson states 'we need to provide psychological support systems' and started the Technostress International Information Network.",
          },
        ],
      },
      {
        instructions:
          "Questions 36–40. Do the following statements agree with the information given in Reading Passage 3? In boxes 36–40, write: TRUE if the statement agrees, FALSE if the statement contradicts, NOT GIVEN if there is no information on this.",
        questions: [
          {
            id: "q36",
            number: 36,
            ...
            answer: "TRUE",
            explanation:
              "The passage states 'Mass exposure to technological innovations in the workplace has come too recently for psychologists to reach a consensus on its societal implications.'",
          },
          {
            id: "q37",
            number: 37,
            ...
            answer: "TRUE",
            explanation:
              "Brod says one of the first signs is 'technostress, a cognitive shift that results from an over-identification with information systems' and that people internalise the patterns of electronic tools.",
          },
          {
            id: "q38",
            number: 38,
            ...
            answer: "TRUE",
            explanation:
              "Dennett points out that it becomes 'increasingly difficult to convince ourselves that we're doing an adequate job'.",
          },
          {
            id: "q39",
            number: 39,
            ...
            answer: "NOT GIVEN",
            explanation:
              "The passage mentions that for executives the benefits may outweigh disadvantages, but does not compare their negative effects to those of junior workers.",
          },
          {
            id: "q40",
            number: 40,
            ...
            answer: "NOT GIVEN",
            explanation:
              "The passage does not mention promotions based on technology skills.",
          },
        ],
      },
    ],
...

  {
    ...
    questionGroups: [
      {
        instructions:
          "Questions 1–6. Look at the following issues (Questions 1-6) and the list of people and organisations below. Match each issue with the correct person or organization, A-F. Write the correct letter, A-F, in boxes 1-6. NB You may use any letter more than once.",
        questions: [
          {
            id: "q1",
            number: 1,
            ...
            answer: "D",
            explanation:
              "Paragraph F discusses the cost of capturing carbon dioxide and Lackner argues it is too expensive to adapt existing plants.",
          },
          {
            id: "q2",
            number: 2,
            ...
            answer: "E",
            explanation:
              "Paragraph G states David Hawkins warns that carbon dioxide could have harmful consequences for marine life.",
          },
          {
            id: "q3",
            number: 3,
            ...
            answer: "D",
            explanation:
              "Paragraph E states Lackner points out that fossil fuels are 'the cheapest and most plentiful energy source available'.",
          },
          {
            id: "q4",
            number: 4,
            ...
            answer: "E",
            explanation:
              "Paragraph J states Hawkins argues that developed nations will have to provide assistance to encourage developing nations to use sequestration.",
          },
          {
            id: "q5",
            number: 5,
            ...
            answer: "A",
            explanation:
              "Paragraph B states Scott Klara reports that airborne carbon dioxide concentrations have risen by nearly a third over the past century.",
          },
          {
            id: "q6",
            number: 6,
            ...
            answer: "F",
            explanation:
              "Paragraph I states the World Wide Fund for Nature Australia argues that the primary risk is that people might become asphyxiated.",
          },
        ],
      },
      {
        instructions:
          "Questions 7–9. Reading Passage 1 has ten paragraphs, A–J. Which paragraph contains the following information? Write the correct letter, A–J, in boxes 7-9.",
        questions: [
          {
            id: "q7",
            number: 7,
            ...
            answer: "H",
            explanation:
              "Paragraph H describes specific examples of underground carbon sequestration in Canada and the North Sea.",
          },
          {
            id: "q8",
            number: 8,
            ...
            answer: "F",
            explanation:
              "Paragraph F mentions that captured carbon emissions are sold for various uses, including carbonating soft drinks.",
          },
          {
            id: "q9",
            number: 9,
            ...
            answer: "C",
            explanation:
              "Paragraph C states that increased levels of carbon-based compounds are believed to be the cause of rising temperatures and sea levels.",
          },
        ],
      },
      {
        instructions:
          "Questions 10–13. Do the following statements agree with the information given in Reading Passage 1? In boxes 10–13, write: TRUE if the statement agrees with the information, FALSE if the statement contradicts the information, NOT GIVEN if there is no information on this.",
        questions: [
          {
            id: "q10",
            number: 10,
            ...
            answer: "TRUE",
            explanation:
              "Paragraph A states that delegates from fourteen industrialised and developing countries agreed to engage in cooperative research into capturing and storing carbon dioxide.",
          },
          {
            id: "q11",
            number: 11,
            ...
            answer: "TRUE",
            explanation:
              "Paragraph D states 'increased energy consumption is a key to economic growth'.",
          },
          {
            id: "q12",
            number: 12,
            type: "true-false-not-given",
            prompt:
              "Capturing carbon dioxide has become financially attractive.",
            answer: "FALSE",
            explanation:
              "Paragraph F states it costs about $US50 to extract and store a tonne and raises electricity costs by 30-80%, and Lackner argues it is too expensive.",
          },
          {
            id: "q13",
            number: 13,
            type: "true-false-not-given",
            prompt:
              "More forests need to be planted to improve the atmosphere.",
            answer: "NOT GIVEN",
            explanation:
              "The passage mentions forests as natural carbon sinks but does not state that more forests need to be planted.",
          },
        ],
      },
    ],
...

  {
    ...
    questionGroups: [
      {
        instructions:
          "Questions 14–21. Reading Passage 2 has nine paragraphs, A–I. Choose the correct heading for paragraphs A and C–I from the list of headings below. Write the correct number, i–xii, in boxes 14–21.",
        questions: [
          {
            id: "q14",
            number: 14,
            ...
            answer: "iv",
            explanation:
              "Paragraph A discusses the large price differences between Stradivarius violins and modern instruments, which is controversial.",
          },
          {
            id: "q15",
            number: 15,
            ...
            answer: "ix",
            explanation:
              "Paragraph C describes traditional manual woodworking techniques used by violin makers.",
          },
          {
            id: "q16",
            number: 16,
            ...
            answer: "ii",
            explanation:
              "Paragraph D describes applying scientific technology to violin production with measurements and loudspeakers.",
          },
          {
            id: "q17",
            number: 17,
            ...
            answer: "viii",
            explanation:
              "Paragraph E mentions the Renaissance view of perfection measured in numbers and exact ratios, suggesting a mathematical basis.",
          },
          {
            id: "q18",
            number: 18,
            ...
            answer: "vi",
            explanation:
              "Paragraph F discusses how the age of wood contributes to improved quality, an advantage of older wood.",
          },
          {
            id: "q19",
            number: 19,
            ...
            answer: "i",
            explanation:
              "Paragraph G discusses the varnish used to protect the instrument, which is a protective coating.",
          },
          {
            id: "q20",
            number: 20,
            ...
            answer: "xi",
            explanation:
              "Paragraph H discusses soaking timber in water to leach out chemicals, which relates to the use of saturated wood.",
          },
          {
            id: "q21",
            number: 21,
            ...
            answer: "x",
            explanation:
              "Paragraph I mentions that some leading soloists play modern instruments but foremost soloists remain unconvinced, discussing preferences.",
          },
        ],
      },
      {
        instructions:
          "Questions 22–26. Do the following statements agree with the information given in Reading Passage 2? In boxes 22–26, write: TRUE if the statement agrees with the information, FALSE if the statement contradicts the information, NOT GIVEN if there is no information on this.",
        questions: [
          {
            id: "q22",
            number: 22,
            ...
            answer: "TRUE",
            explanation:
              "Paragraph B states 'Individual notes on a single instrument sound different each time they are played'.",
          },
          {
            id: "q23",
            number: 23,
            ...
            answer: "FALSE",
            explanation:
              "Paragraph C states 'The ear is a supreme detection device, and a system has yet to be developed which can match the brain's sophisticated ability to assess complex sounds.'",
          },
          {
            id: "q24",
            number: 24,
            ...
            answer: "NOT GIVEN",
            explanation:
              "The passage does not mention the musical ability of the craftsman affecting violin quality.",
          },
          {
            id: "q25",
            number: 25,
            ...
            answer: "TRUE",
            explanation:
              "Paragraph F states 'This may also explain why the quality of a modern instrument appears to improve in its first few years.'",
          },
          {
            id: "q26",
            number: 26,
            ...
            answer: "FALSE",
            explanation:
              "Paragraph I states that the foremost soloists 'remain utterly unconvinced' about modern instruments.",
          },
        ],
      },
    ],
        ...
        questions: [
          {
            ...
            type: "multiple-choice",
            prompt:
              "What does the writer tell us about people with tone deafness (amusia) in the first paragraph?",
            options: [
            ...
            answer: "D",
            explanation:
              "The first paragraph states that amusics 'are unable to sing in tune, they are also unable to discriminate between tones or recognize familiar melodies'.",
          },
          {
            id: "q28",
            number: 28,
            ...
            answer: "B",
            explanation:
              "The second paragraph summarizes Dr. Peretz's research findings about what amusics can and cannot do.",
          },
          {
            id: "q29",
            number: 29,
            type: "multiple-choice",
            prompt:
              "What does the writer say about the relationship between language ability and musical ability?",
            options: [
              {
                key: "A",
            ...
            answer: "A",
            explanation:
              "Paragraph 3 states 'People with brain damage in areas critical to language are often still able to sing, despite being unable to communicate through speech.'",
          },
          {
            id: "q30",
            number: 30,
            type: "multiple-choice",
            prompt:
              "In the third paragraph, the writer notes that most amusics are able to",
            options: [
            ...
            answer: "C",
            explanation:
              "Paragraph 3 states 'Amusics are also successful most of the time at detecting the mood of a melody'.",
          },
          {
            id: "q31",
            number: 31,
            ...
            answer: "B",
            explanation:
              "Paragraph 4 describes how research has moved from the temporal lobes to the temporal neocortex and now suggests deficits are outside the auditory cortex.",
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            type: "yes-no-not-given",
            prompt:
              "Peretz's research suggesting that amusia is a disorder is convincing.",
            answer: "NO",
            explanation:
              "Paragraph 5 states 'As a student of neurobiology, however, I am skeptical' about Peretz's research.",
          },
          {
            id: "q33",
            number: 33,
            ...
            answer: "NOT GIVEN",
            explanation:
              "The passage does not mention happiness in relation to musical ability.",
          },
          {
            id: "q34",
            number: 34,
            ...
            answer: "YES",
            explanation:
              "Paragraph 6 states 'Comparing this \"disorder\" to learning disorders like a specific language impairment seems to be going too far' and questions whether it should be considered a disability.",
          },
          {
            id: "q35",
            number: 35,
            ...
            answer: "NOT GIVEN",
            explanation:
              "The passage mentions bad handwriting only as an analogy, not as a characteristic of amusics.",
          },
        ],
      },
      {
        instructions:
          "Questions 36–40. Complete each sentence with the correct ending, A-H below. Write the correct letter, A-H in boxes 36-40.",
        questions: [
          {
            id: "q36",
            number: 36,
            ...
            options: [
              {
                key: "A",
                text: "an inability to hear when spoken language rises and falls.",
              },
            ...
            answer: "E",
            explanation:
              "The first paragraph states research has been undertaken to discover the cause of congenital amusia, but doesn't provide a definitive reason.",
          },
          {
            id: "q37",
            number: 37,
            ...
            answer: "C",
            explanation:
              "Paragraph 2 states amusics perform significantly worse at 'tapping a rhythm along with a melody'.",
          },
          {
            id: "q38",
            number: 38,
            ...
            answer: "D",
            explanation:
              "Paragraph 3 states 'The linguistic cues inherent in speech make discrimination of meaning much easier for amusics.'",
          },
          {
            id: "q39",
            number: 39,
            ...
            answer: "G",
            explanation:
              "Paragraph 4 states that when changes in tones are large, amusics' brains show 'twice as much activity on the right side of the brain as a normal brain'.",
          },
          {
            id: "q40",
            number: 40,
